...
--
-- Host: 127.0.0.1
-- Czas generowania: 10 Lis 2023, 10:15
...
INSERT INTO `orders` (`orderID`, `userName`, `eventName`, `eventID`, `ticketName`, `ticketPrice`, `ticketDate`) VALUES
(22, 'testowy', 'Travis Scott ', 1, 'Gold Ticket', 600, '2023-11-10 10:03:03'),
(23, 'testowy', 'Drake ', 4, 'Gold Ticket', 1000, '2023-11-10 10:03:08'),
(24, 'testowy', 'Pitbull ', 3, 'VIP+ Ticket', 1000, '2023-11-10 10:03:20'),
(25, 'zaq1@WSX', 'Pitbull ', 3, 'Standard Ticket', 350, '2023-11-10 10:12:16');
...
(14, 'admin', 'admin', ''),
(15, 'testowy', '$2y$10$VfHjrl2jrUaITrSO6NuyM.wBTDeAuDrOS9nlMMpsVHlYUDLVQUdRi', '+48 111222333');
